...
Ext.define('Ext.grid.feature.GroupStore', {
    ...
    processStore: function (store) {
        var me = this,
            ...
            metaGroup, metaGroupCache, i, len, group, groupName, groupPlaceholder, key, modelData, Model;
        ...
        if (store.getCount()) {
            ...
            if (groupCount > 0) {
                ...
                for (i = 0; i < groupCount; i++) {
                    ...
                    metaGroup = metaGroupCache[key] = oldMetaGroupCache[key] ?
                        oldMetaGroupCache[key] :
                        groupingFeature.getMetaGroup(key);
