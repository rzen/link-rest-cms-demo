...
Ext.define('Ext.grid.feature.Grouping', {
    ...
    generateSummaryData: function(){
        ...
        for (i = 0, len = groups.length; i < len; ++i) {
            ...
            if (updateNext || hasRemote || store.updating || ((metaGroup.lastGroupGeneration !== group.generation) || metaGroup.lastFilterGeneration !== filters.generation)) {
    ...
    destroy: function() {
        ...
        me.view = me.prunedHeader = me.grid = me.dataSource = null;
        me.invalidateCache();
