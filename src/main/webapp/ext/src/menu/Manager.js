...
Ext.define('Ext.menu.Manager', {
    ...
    constructor: function() {
        ...
        me.onShow = function () {
            ...
            // Need to use doc, not the body, since the body may not have a
            // size if there's nothing in the body to cause it to gain a height.
            Ext.getDoc().on('mousedown', me.checkActiveMenus, me);
